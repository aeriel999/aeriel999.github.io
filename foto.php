...
<?php 
$dir = "pic";            // Шлях
$files = scandir($dir);  // Список файлів
for($i=2; $i<count($files); $i++)
{
?>
<img src="<?php echo $dir; ?>/<?php echo $files[$i]; ?>" alt="" width="350" height="250" hspace="5" vspace="7" border="5" onclick="this.classList.toggle('big')">
<?php } ?>
<!-- ===================================================================================================================== -->   
   </td>
    </tr>
