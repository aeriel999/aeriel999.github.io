...
<!-- ========================================================================================= -->	  
<H1 align="center"><font color="green">Пошук телефону</font></H1>
 <form action="tel09.php" method="post" onsubmit="return send();">
<TABLE align="center" bgcolor="#ccc">
<TR>
<TD><font color="green" size="5">Номер телефону</font>: </TD>
<TD><input type="text" size="10" maxlength="20" name="ntel"> </TD>
</TR>
<TR>
<TD><font color="green" size="5">Призвище</font> :  </TD>
<TD><input type="text" size="10" maxlength="20" name="fio"> </TD>
</TR>
<TR>
<TD><font color="green" size="5">Вулиця</font> : </TD>
<TD><input type="text" size="10" maxlength="20" name="nstreet"></TD>
</TR>
<TR>
<TD><font color="green" size="5">Будинок</font> : </TD>
<TD><input type="text" size="10" maxlength="20" name="ndom"></TD>
</TR>
<TR>
<TD><font color="green" size="5">Квартира</font> : </TD>
