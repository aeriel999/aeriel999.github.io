...
<!-- ========================================================================================= -->	  
<?php	   
    $ctime = date("dMY H:i:s");
    $st = $_POST['name2'].";".$_POST['name1'].";".$_POST['email'].";".$_POST['password'].";$ctime;\n";
    $fp=fopen("txt/baza.txt","a");
    fwrite($fp,$st);
    echo "<h1 align='center'>".$_POST['name2']." ".$_POST['name1']."<br>";
    echo "Дякуємо за реєстрацію!!</h1>";
    echo "<h2 align='center'>На Вашу E-Mail :".$_POST['email']." выдправлено повыдомлення";
?> 
<!-- ===================================================================================================================== -->   
   </td>
    </tr>
